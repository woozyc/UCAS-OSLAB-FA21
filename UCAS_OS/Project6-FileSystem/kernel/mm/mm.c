...
freemem_node freemem_pool[2] = {{-1}};//index is linear mapped to pa
int freemem_head = -1;

//swap vpage pool
swapmem_node swapmem_pool[2] = {{0, 0, 0, 0}};//index is NOT linear mapped to pa
int swapmem_head = -1;

//alloc fifo pool, only store swappable pgs
allocmem_node allocmem_pool[2] = {{0, 0, 0}};//index is NOT linear mapped to pa
int allocmem_head = -1;
